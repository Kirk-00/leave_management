                            ...
                            <td>
                              <span
                                className={classNames("badge", {
                                  "bg-success": record?.TagStatus,
                                  "bg-danger": !record?.TagStatus,
                                })}
                              >
                ...
                <Col>
                  <div className="d-lg-flex align-items-center text-center pb-1">
                    ...
                    <span className="me-3">
                      Page
                      <strong>
                        {pageNumber} of {Math.ceil(TotalTag / perPage)}
                      </strong>
                    </span>
